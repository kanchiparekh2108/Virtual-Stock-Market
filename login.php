...
?></br><?php }?> Login</h3>
			<form  method="post">
				<span>
					<input type="text" name="email" id="input-7" placeholder="email">
					<label for="input-7">
				...
				<span>
				 <input type="password" name="password" id="input-8" placeholder="Password">
				...
				<div class="agileinfo_remember">
					...
					<div class="clearfix"> </div>
                            ...
                            <input type="submit" value="Submit" name="btn_submit" onclick="return hello()">
