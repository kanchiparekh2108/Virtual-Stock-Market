				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<nav class="wthree_nav">
						<ul class="nav navbar-nav nav_1">
                                                    <li class="act"><a href="Welcome.php">Home</a></li>
                                                    <li><a href="equity.php">Equity</a></li>
                                                    <li><a href="commodities.php">Shares</a></li>
                                                    <li><a href="news.php">Profile</a></li>
                                                    <li><a href="products.php">Customer Services</a></li>
							<li>
...
<div style="background-color:#b9e685; height: 500px;">
    </br>
...
error_reporting(E_ALL ^ E_DEPRECATED);
 mysql_connect("localhost", "root");
                                         mysql_select_db("vsm");
$query2 = " SELECT `Name` FROM `registration` WHERE `lid`= $lid"; 
...
?>
    <h1 align = center style="margin-top: 250px;  font-size:35pt" >Welcome <?php echo $rw["Name"];?></h1>
